...
set "SCRIPT_UNC=\\fileserver\Almoxarifado\0800\servidor\dark-jutsu\scripts\iniciar_postgres_darkjutsu.bat"
set "SHORTCUT_NAME=Iniciar PostgreSQL Dark-Jutsu.lnk"
