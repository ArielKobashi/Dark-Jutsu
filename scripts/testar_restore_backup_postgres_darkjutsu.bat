...
if not exist "%PG_BIN%\pg_restore.exe" set "PG_BIN=C:\DarkJutsu\PostgreSQL\pgsql\bin"
if not exist "%PG_BIN%\pg_restore.exe" set "PG_BIN=%LOCALAPPDATA%\DarkJutsu\PostgreSQL\pgsql\bin"
if not exist "%PG_BIN%\pg_restore.exe" set "PG_BIN=%USERPROFILE%\Desktop\aplicacoes code\pgsql\bin"
if not exist "%PG_BIN%\pg_restore.exe" set "PG_BIN=%USERPROFILE%\Desktop\pgsql\bin"
